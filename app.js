document.addEventListener('DOMContentLoaded', () => {
    ...
    // -----------------------------------------------------------------------
    // Trage hier deine Live-Render-URL des Backends ein (z.B. https://mvb-backend.onrender.com)
    const BACKEND_URL = 'https://mvb-app.onrender.com';
    
    const API_BASE = (
        window.location.hostname === 'mvb-app.onrender.com' ||
