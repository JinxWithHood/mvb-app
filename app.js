document.addEventListener('DOMContentLoaded', () => {
    ...
    // Secret Typing-Only Listener (NO clicks, NO Konami, ONLY typing!)
    window.addEventListener('keydown', (e) => {
        ...
        if (e.target.tagName === 'INPUT' || e.target.tagName === 'TEXTAREA') {
            ...
            if (val.includes('jinx') || val.includes('arcane') || val.includes('powder') || val.includes('zaun')) {
        ...
        if (keyBuffer.includes('jinx') || keyBuffer.includes('arcane') || keyBuffer.includes('powder') || keyBuffer.includes('zaun')) {
            keyBuffer = '';
            triggerJinxUnlock(true);
        }
    });
